...
const getCarsBySiteIdsService = async (req: Request, res: Response) => {
    if (!req.query.site || typeof req.query.site !== 'string' || !req.query.ids) {
        ...
        */
        ...
        try {
            ...
            console.log('Error getCarsBySiteIdsService', error);  //Acá en realidad, reportaríamos el error en vez de loguearlo por consola.
            res.status(500).send('Ocurrió un error al procesar el pedido.');
        }
    }
}

export default getCarsBySiteIdsService;